...
namespace ms {
    ...
    __attribute__((unused)) static uint8_t sum8check(const uint8_t *data, int length) {
        uint8_t sumCheck = 0;
    ...
    __attribute__((unused)) static uint16_t crc16check(const uint8_t *data, int length) {
        uint8_t chData;
    ...
    __attribute__((unused)) static uint16_t sum16check(const uint8_t *data, int length) {
        uint16_t sumCheck = 0;
        for (int i = 0; i < length; ++i) {
            sumCheck += data[i];
        }
